    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col m8 s12" id="offname">
          <p>
            Commissionerate of e-Governance<br /><span
              >Tamil Nadu e-Governance Agency</span
            >
          </p>
        </div>
        <div class="col m2 s12">
          <div class="logo"><img src="<?php echo base_url() ?>assets/img/tnlogo.png" alt="TNeGA" /></div>
        </div>
      </div>
    </div>