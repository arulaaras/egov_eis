<?php
$this->load->view('dashboard/header2',['title'=>'CeG Dashboard']);
...
<div class="row container" style="width:1100px!important;">
  ...
  <blockquote>
    <h5>USER ID: &nbsp;<?= $p->username ?></h5>
  </blockquote>
  <div class="col m4 l4 s12 card center hide-on-small-only">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="responsive-img" src="<?php echo base_url() ?>assets/profilepic/<?= $p->user_id?>.jpg">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">
        <h5 class="blue-text text-darken-4" style="font-size: 20px;">
          <?= $p->salutation?>&nbsp;<?= $p->first_name ?>&nbsp;&nbsp;<?= $p->last_name ?></h5>
      </span>
          ...
          <table class="striped center-align">
            ...
            <tbody class="center">
              ...
              <tr>
                ...
                <th><a class="btn-floating btn-medium green waves-effect waves-light modal-trigger"
                    href="#edu-edit<?php echo $edu->edu_id?>"><i class="material-icons">mode_edit</i></a>
                  <a class="btn-floating btn-medium red waves-effect waves-light modal-trigger"
                    href="<?php echo base_url()?>crud/deleteedu/<?php echo $edu->edu_id ?>"><i
          ...
          <table class="striped center-align">
            ...
            <tbody>
              ...
              <tr>
                ...
                <th><?= $emp->emp_exp?></th>
                <th><a class="btn-floating btn-medium green waves-effect waves-light modal-trigger"
                    href="#emp-edit<?php echo $emp->id?>"><i class="material-icons">mode_edit</i></a>
                  <a class="btn-floating btn-medium red waves-effect waves-light modal-trigger"
                    href="<?php echo base_url()?>crud/deleteemp/<?php echo $emp->id ?>"><i
                      class="material-icons">delete</i></a>
    ...
    <li>
      ...
      <div class="collapsible-body">
        <p>
          ...
          <table class="striped center-align">
            ...
            <tbody class="center">
              ...
              <tr>
                ...
                <th><a class="btn-floating btn-medium green waves-effect waves-light modal-trigger"
                    href="#skills-edit<?php echo $skl->id?>"><i class="material-icons">mode_edit</i></a>
                  <a class="btn-floating btn-medium red waves-effect waves-light modal-trigger"
                    href="<?php echo base_url()?>crud/deleteskl/<?php echo $skl->id ?>"><i
                      class="material-icons">delete</i></a>
          ...
          <button class="btn blue waves-effect waves-light  modal-trigger centered" href="#skills-add">Add More
            Skills</button>
        </p>
        <br>
        <p>
          ...
          <table class="striped center-align">
            ...
            <tbody class="center">
              ...
              <tr>
                ...
                <th><a class="btn-floating btn-medium green waves-effect waves-light modal-trigger"
                    href="#learn-edit<?php echo $l->id?>"><i class="material-icons">mode_edit</i></a>
                  <a class="btn-floating btn-medium red waves-effect waves-light modal-trigger"
                    href="<?php echo base_url()?>crud/deletelearn/<?php echo $l->id ?>"><i
                      class="material-icons">delete</i></a>
          ...
          <button class="btn blue waves-effect waves-light  modal-trigger centered" href="#learn-add">Add More
            Skills</button>
        </p>
      </div>
    </li>
