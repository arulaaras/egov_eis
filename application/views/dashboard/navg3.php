    ...
    <div class="container">
      <div class="nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li>
            <a href="<?php echo base_url()?>dashboard/view_employess">View Employees</a>
          </li>
          <li>
            <a href="<?php echo base_url()?>dashboard/modifyprofile">Update Profile</a>
          </li>
          <li>
        ...
        <ul id="side-nav" class="side-nav">
          <li>
            <div class="user-view">
              <div class="background">
                <img src="<?php echo base_url() ?>assets/img/ocean.jpg" alt="">
              </div>
              <a href="#">
          ...
          <li>
            <a href="<?php echo base_url()?>users/logout" class="waves-effect">Logout</a>
          </li>
        </ul>
      </div>
    </div>
